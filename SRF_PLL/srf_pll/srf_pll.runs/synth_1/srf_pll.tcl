...
synth_design -top srf_pll -part xc7z020clg484-1
...
write_checkpoint -force -noxdef srf_pll.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file srf_pll_utilization_synth.rpt -pb srf_pll_utilization_synth.pb"  } 
