...
HD_PWD='C:/Users/user/Desktop/srf_pll/SRF_PLL/srf_pll/srf_pll.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log srf_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source srf_pll.tcl
